...
# This script will generate an appropriate .sh file for a LAMMPS input script for use on Raider.
...
#SBATCH --account=ERDCV00898FAE
#SBATCH --qos ${queue}
#SBATCH --job-name=${script}
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT
#SBATCH --mail-user=william.a.pisani@erdc.dren.mil
...
lmp_dir=/p/work1/wapisani/LAMMPS_Binaries
...
mpiexec -n ${total_cores} \${lmp_dir}/lmp_20250529_aocc -in \${script_name}
EOM
